class TranscriptOptionsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @transcript_option.save
          format.html { redirect_to @transcript_option, notice: 'Transcript config was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @transcript_option.update(transcript_config_params)
          format.html { redirect_to @transcript_option, notice: 'Transcript config was successfully updated.' }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to transcript_options_url, notice: 'Transcript config was successfully destroyed.' }
